/**
 * Created by Bizon on 18.01.2019.
 */
...
public class SnmpSetExample
{
    ...
    private static String  port    = "4161";

    // sysContact OID of MIB RFC 1213; Scalar Object = .iso.org.dod.internet.mgmt.mib-2.system.sysContact.0
    private static String  sysContactOid  = ".1.3.6.1.4.1.4976.12.3.1.2.1";  // ends with 0 for scalar object
